<div id="login-modal">
  ...
  <div class="modal">
    ...
    <div class="modal-body">
      <form id="loginForm" action="/member/login">
        <div class="control-group">
          <div class="user-id">
          <input type="text" placeholder="请输入邮箱/用户名" name="username"
        ...
        <div class="control-group">
          <div class="r">
            <button type="button" onclick="userLogin()" class="btn btn-primary btn-login">登录</button>
          </div>
        </div>
